        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            {[
              ...
              { step: '02', title: 'ประกาศผล', desc: '1 ตุลาคม 2569', color: 'border-teal-500' },
              { step: '03', title: 'ประกาศผลสำรอง', desc: '6 ตุลาคม 2569', color: 'border-orange-500' },
              { step: '04', title: 'วันจัดค่าย', desc: '6-8 พฤศจิกายน 2569', color: 'border-indigo-500' }
            ].map((item, index) => (
