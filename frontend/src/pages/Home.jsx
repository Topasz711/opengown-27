        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="space-y-6 text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              พบกับค่ายเปิดเสื้อกาวน์ ครั้งที่ 27 (Opengown Camp 27th) ในธีม The Gardenia Secret Door: Where Dreams Awaken 
              เปิดประตูแห่งความฝัน พาน้อง ๆ มาทำความรู้จักกับ 'แพทย์วชิระ' มากขึ้น 
              ผ่านกิจกรรมภายในค่ายที่อัดแน่นไปด้วยความรู้และความสนุกจากพี่ ๆ นศพ.ตัวจริง
            </p>
